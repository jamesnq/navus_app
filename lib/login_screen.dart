      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Center(
            ...
            //input data
                //ID
                InputData(textHint: "Fleet ID", icon: assets_id, size: size),

                Spacer(),

                //name
                InputData(textHint: "Username", icon: assets_userName, size: size),
...
//passwor       //password
                InputData(textHint: "Password", icon: assets_lock, size: size, password: true, onTap: () {
                  setState(() {
                ...
                roundedButton(text: "Login", onPressed: () {
                  var route = MaterialPageRoute(builder: (context) => VehiCleAssignmentScreen());
...
Widget InputData({required String? textHint, required String icon, required size, bool password = false, onTap}) {
  if(password == false) {
    return Container(
